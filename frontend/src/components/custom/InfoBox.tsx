...
export function InfoBoxGroup({ children }: InfoBoxGroupProps) {
    ...
    return (
       <div className="grid grid-cols-2 gap-0 w-full lg:w-fit h-fit">
            {children}
        </div>
    )
}
...
export function InfoBox({ label, value, className }: InfoBoxProps) {
    ...
    return (
        <div className={cn("flex flex-col px-4 py-[18px] w-full lg:w-40 h-fit border border-neutral-200 -mt-px -ml-px", className)}>
...
export function InfoBoxSpecial({ label, value, className }: InfoBoxProps) {
    ...
    return (
        <div className={cn("flex flex-col px-4 py-[18px] w-full lg:w-40 h-fit border border-neutral-200 -mt-px -ml-px bg-neutral-50", className)}>
            <div className="font-mono text-xs tracking-[2px] text-neutral-500">{label.toUpperCase()}</div>
