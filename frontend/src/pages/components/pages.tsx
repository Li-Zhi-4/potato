...
import { type CreateComponentInput, createComponent, type Component } from "@/apis/components"
                        ...
                        <div className="px-8">
                            <FieldGroup>
                                <div className="flex flex-row gap-4">
                                    ...
                                    <Field>
                                        <FieldLabel htmlFor="bom-id">BOM Id</FieldLabel>
                                        <Input
                                            id="bom-id"
                                            type="text"
                                            placeholder=""
                                ...
                                <div className="flex flex-row gap-4">
                                    <Field>
                                        <FieldLabel htmlFor="part-vendor-id">Part/Vendor Id</FieldLabel>
                                        <Input
                                            id="part-vendor-id"
                                            type="text"
                                            placeholder=""
                                    ...
                                    <Field>
                                        <FieldLabel htmlFor="purchase-order-id">Purchase Order Id</FieldLabel>
                                        <Input
